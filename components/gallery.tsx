...
export default function Gallery() {
  ...
  const categories = ['all', 'pencil-portrait', 'still-life'];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-base text-foreground/60 max-w-2xl mx-auto">
            A collection of handcrafted pencil portraits and detailed still life sketches that capture emotion and artistry.
          </p>
        </div>
